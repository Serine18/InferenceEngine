...
private static List<Predicate> predicatelist,newpredicatelist,partialsolutions,falsepredicates;
...
private InferenceEngine(){
	...
	falsepredicates=new ArrayList<Predicate>();}
...
public static boolean falsePredicate(Predicate p)
{for(Predicate q:falsepredicates)
	if(q.equals(p)){
...
public static void addfalsePredicate(Predicate p) {
	falsepredicates.add(p);}
